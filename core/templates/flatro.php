...
<!-- Reset CSS -->
<link href="/assets/flatro/css/normalize.css" rel="stylesheet" type="text/css"/>

<!-- Bootstrap core CSS -->
<link href="/assets/flatro/css/bootstrap.css" rel="stylesheet">

<!-- Iview Slider CSS -->
<link href="/assets/flatro/css/iview.css" rel="stylesheet">

<!--	Responsive 3D Menu	-->
<link href="/assets/flatro/css/menu3d.css" rel="stylesheet"/>

<!-- Animations -->
<link href="/assets/flatro/css/animate.css" rel="stylesheet" type="text/css"/>

<!-- Custom styles for this template -->
<link href="/assets/flatro/css/custom.css" rel="stylesheet" type="text/css" />

<!-- Style Switcher -->
<link href="/assets/flatro/css/style-switch.css" rel="stylesheet" type="text/css"/>

<!-- Color -->
<link href="/assets/flatro/css/skin/color.css" id="colorstyle" rel="stylesheet">

<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
<!--[if lt IE 9]> <script src="/assets/flatro/js/html5shiv.js"></script> <script src="/assets/flatro/js/respond.min.js"></script> <![endif]-->

<!-- Bootstrap core JavaScript -->
<script src="/assets/flatro/js/jquery-1.10.2.min.js"></script>
<script src="/assets/flatro/js/bootstrap.min.js"></script>
<script src="/assets/flatro/js/bootstrap-select.js"></script>

<!-- Custom Scripts -->
<script src="/assets/flatro/js/scripts.js"></script>

<!-- MegaMenu -->
<script src="/assets/flatro/js/menu3d.js" type="text/javascript"></script>

<!-- iView Slider -->
<script src="/assets/flatro/js/raphael-min.js" type="text/javascript"></script>
<script src="/assets/flatro/js/jquery.easing.js" type="text/javascript"></script>
<script src="/assets/flatro/js/iview.js" type="text/javascript"></script>
<script src="/assets/flatro/js/retina-1.1.0.min.js" type="text/javascript"></script>

<!--[if IE 8]>
    <script type="text/javascript" src="/assets/flatro/js/selectivizr.js"></script>
    <![endif]-->
  ...
  <div class="container">
    <div class="row clearfix">
      <div class="col-lg-3 col-xs-12">
        <div class="logo"> <a href="/assets/flatro/index.html" title="Flatro Template"><!-- <img alt="Flatro - Responsive Metro Inspired Flat ECommerce theme" src="/assets/flatro/images/logo2.png"> -->
      ...
      <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 menu-col">
        ...
        <div class="menu3dmega vertical" id="menuMega">
          <ul>
            ...
            <li class="visible-xs"> <a href="/assets/flatro/index.html"> <i class="fa fa-home"></i> <span>Home</span> <i class="fa fa-angle-right"></i> </a>
              <div class="dropdown-menu flyout-menu"> 
                <!-- Sub Menu -->
                <ul>
                  <li><a href="/assets/flatro/about.html">About us</a></li>
                  <li><a href="/assets/flatro/blog.html">Blog</a></li>
                  <li> <a href="#a"><span>Account</span> <i class="fa fa-caret-right"></i> </a>
                    <ul class="dropdown-menu sub flyout-menu">
                      ...
                      <li><a href="/assets/flatro/cart.html">Shopping Cart</a></li>
                      <li><a href="/assets/flatro/checkout.html">Checkout</a></li>
                    </ul>
                  </li>
                  <li> <a href="#a"><span>Product</span> <i class="fa fa-caret-right"></i> </a>
                    <ul class="dropdown-menu sub flyout-menu">
                      <li><a href="/assets/flatro/category-grid.html">Category Grid</a></li>
                      <li><a href="/assets/flatro/category-list.html">Category List</a></li>
                      <li><a href="/assets/flatro/product.html">Product Page</a> </li>
                    </ul>
                  </li>
                  <li><a href="/assets/flatro/cart.html">Shoping Cart</a></li>
                  <li><a href="/assets/flatro/checkout.html">Checkout</a></li>
                  <li><a href="/assets/flatro/blog-single.html">Blog Post</a></li>
                  <li><a href="/assets/flatro/contact.html">Contact us</a></li>
                </ul>
                <!-- end: Sub Menu --> 
              </div>
            </li>
            ...
            <li class="hidden-xs"> <a href="#a"> <i class="fa fa-files-o"></i> <span>Pages</span> <i class="fa fa-angle-right"></i> </a>
              <div class="dropdown-menu flyout-menu"> 
                <!-- Sub Menu -->
                <ul>
                  <li><a href="/assets/flatro/index.html">Home</a></li>
                  <li><a href="/assets/flatro/about.html">About us</a></li>
                  <li><a href="/assets/flatro/blog.html">Blog</a></li>
                  <li><a href="/assets/flatro/blog-single.html">Blog Post</a></li>
                  <li> <a href="#a"><span>Product</span> <i class="fa fa-caret-right"></i> </a>
            ...
            <li> <a href="#a"> <i class="fa fa-male"></i> <span>Men Wear</span> <i class="fa fa-angle-right"></i> </a>
              <div class="dropdown-menu"> 
                ...
                <div class="content">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p> <a href="#a"><img alt="" src="/assets/flatro/images/menu-ad.jpg"></a> </p>
                    </div>
                  </div>
                </div>
                <!-- end: Sub Menu --> 
                    ...
                    <div class="col-md-7">
                      <div class="product-block">
                        <div class="image">
                          ...
                          <a class="img" href="/assets/flatro/product.html"><img alt="product info" src="/assets/flatro/images/products/product1.jpg" title="product title"></a> </div>
                        <div class="product-meta">
                          <div class="name"><a href="/assets/flatro/product.html">Ladies Stylish Handbag</a></div>
                          ...
                          <div class="big-btns"> <a class="btn btn-default btn-view pull-left" href="/assets/flatro/">View</a> <a class="btn btn-default btn-addtocart pull-right" href="/assets/flatro/">Add to
                            Cart</a> </div>
      ...
      <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 menu-col-2"> 
        ...
        <div class="menu-links hidden-xs">
          <ul class="nav nav-pills nav-justified">
            <li> <a href="/assets/flatro/index.html"> <i class="fa fa-home fa-fw"></i> <span class="hidden-sm">Home</span></a> </li>
            <li> <a href="/assets/flatro/about.html"> <i class="fa fa-info-circle fa-fw"></i> <span class="hidden-sm">About</span></a> </li>
            <li> <a href="/assets/flatro/blog.html"> <i class="fa fa-bullhorn fa-fw"></i> <span class="hidden-sm">Blog</span></a> </li>
            <li> <a href="/assets/flatro/contact.html"> <i class="fa fa-pencil-square-o fa-fw"></i> <span class="hidden-sm ">Contact</span></a> </li>
            <li class="dropdown"> <a href="/assets/flatro/cart.html"> <i class="fa fa-shopping-cart fa-fw"></i> <span class="hidden-sm"> 5 items | $4530.00</span></a> 
              <!-- Quick Cart -->
        ...
        <div class="slider">
          <div id="iview"> 
            ...
            <div data-iview:image="images/slide0.jpg" data-iview:pausetime="60000">
              <div class="iview-caption metro-box1 orange" data-transition="wipeUp" data-x="95" data-y="209"> <a href="/assets/flatro/about.html">
              ...
              <div class="iview-caption metro-box2" data-transition="expandLeft" data-x="438" data-y="209">
                <div class="monthlydeals">
                  <div class="monthly-deals slide" id="monthly-deals">
                    <div class="carousel-inner">
                      <div class="item active"> <a href="#a"> <img alt="" src="/assets/flatro/images/slider-deal1.jpg"> </a> </div>
                      <div class="item"> <a href="#a"> <img alt="" src="/assets/flatro/images/slider-deal2.jpg"> </a> </div>
                      <div class="item"> <a href="#a"> <img alt="" src="/assets/flatro/images/slider-deal3.jpg"> </a> </div>
                      <div class="item"> <a href="#a"> <img alt="" src="/assets/flatro/images/slider-deal4.jpg"> </a> </div>
                    </div>
                  </div>
          ...
          <div class="carousel-inner"> 
            ...
            <div class="item active">
              <div class="row box-product"> 
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <div class="product-block">
                    <div class="image"> <a class="img" href="/assets/flatro/product.html"><img alt="product info" src="/assets/flatro/images/products/product2.jpg" title="product title"></a> </div>
                    <div class="product-meta">
                      <div class="name"><a href="/assets/flatro/product.html">Female Strips Handbag</a></div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <div class="product-block">
                    <div class="image">
                      ...
                      <a class="img" href="/assets/flatro/product.html"><img alt="product info" src="/assets/flatro/images/products/product3.jpg" title="product title"></a> </div>
                    <div class="product-meta">
                      <div class="name"><a href="/assets/flatro/product.html">Blue Fashion Bag</a></div>
          ...
          <div class="carousel-inner"> 
            ...
            <div class="item">
              <div class="product-block">
                <div class="image"> <a class="img" href="/assets/flatro/product.html"><img alt="product info" src="/assets/flatro/images/products/product2.jpg" title="product title"></a> </div>
                <div class="product-meta">
                  <div class="name"><a href="/assets/flatro/product.html">Strips Stylish Handbag</a></div>
            ...
            <div class="item">
              <div class="product-block">
                <div class="image"> <a class="img" href="/assets/flatro/product.html"><img alt="product info" src="/assets/flatro/images/products/product3.jpg" title="product title"></a> </div>
                <div class="product-meta">
                  <div class="name"><a href="/assets/flatro/product.html">Blue Stylish Handbag</a></div>
          ...
          <div class="carousel-inner"> 
            ...
            <div class="item">
              <div class="product-block">
                <div class="image"> <a class="img" href="/assets/flatro/product.html"> <img alt="product info" src="/assets/flatro/images/products/product3.jpg" title="product title"></a> </div>
                <div class="product-meta">
                  <div class="name"><a href="/assets/flatro/product.html">Females Stylish Handbag</a></div>
                  <div class="big-price"> <span class="price-new"><span class="sym">$</span>1600</span> </div>
                  <div class="big-btns"> <a class="btn btn-default btn-view pull-left" href="/assets/flatro/">View</a> <a class="btn btn-default btn-addtocart pull-right" href="/assets/flatro/">Add to
                    Cart</a> </div>
                </div>
            ...
            <div class="carousel-inner"> 
              ...
              <div class="blog-entry item">
                <div class="image"> <span class="blogico"> <i class="fa fa-bullhorn fa-fw"></i><br>
                  Blog entry</span> <img class="ani-image" src="/assets/flatro/images/blog-4.jpg" alt="image info"> </div>
                <div class="entry-row">
              ...
              <div class="blog-entry item">
                <div class="image"> <span class="blogico"> <i class="fa fa-bullhorn fa-fw"></i><br>
                  Blog entry</span> <img class="ani-image" src="/assets/flatro/images/blog-1.jpg" alt=""> </div>
                <div class="entry-row">
              ...
              <div class="blog-entry item active">
                <div class="image"> <span class="blogico"> <i class="fa fa-bullhorn fa-fw"></i><br>
                  Blog entry</span> <img class="ani-image" src="/assets/flatro/images/blog-2.jpg" alt=""> </div>
                <div class="entry-row">
              ...
              <div class="blog-entry item">
                <div class="image"> <span class="blogico"> <i class="fa fa-bullhorn fa-fw"></i><br>
                  Blog entry</span> <img class="ani-image" src="/assets/flatro/images/blog-3.jpg" alt=""> </div>
                <div class="entry-row">
            ...
            <div class="box-products box-brands slide" id="brands">
              ...
              <div class="carousel-inner">
                <div class="brands-row item active">
                  <div class="brand-logo"><a href="#a"><img src="/assets/flatro/images/brands/logo1.png" alt=""></a></div>
                  <div class="brand-logo"><a href="#a"><img src="/assets/flatro/images/brands/logo2.png" alt=""></a></div>
                  <div class="brand-logo"><a href="#a"><img src="/assets/flatro/images/brands/logo3.png" alt=""></a></div>
                  <div class="brand-logo"><a href="#a"><img src="/assets/flatro/images/brands/logo1.png" alt=""></a></div>
                </div>
  ...
  <div class="copyrights">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-sm-4 col-xs-12 payment-icons"> <a href="#a"> <img src="/assets/flatro/images/icons/discover.png" alt="discover"> </a> <a href="#a"> <img src="/assets/flatro/images/icons/2co.png" alt="2co"> </a> <a href="#a"> <img src="/assets/flatro/images/icons/paypal.png" alt="paypal"> </a> <a href="#a"> <img src="/assets/flatro/images/icons/mastercard.png" alt="master card"> </a> <a href="#a"> <img src="/assets/flatro/images/icons/visa.png" alt="visa card"> </a> <a href="#a"> <img src="/assets/flatro/images/icons/moneybookers.png" alt="moneybookers"> </a> </div>
      </div>
    </div>
  </div>
</footer>
