<header id="site-header" class="site-header" role="banner">
    ...
    <nav id="second-menu" role="navigation">
        <a href="#" class="close no-border"><?php echo __('close'); ?> <span>&#215;</span></a>
        <?php require('_menu.php'); ?>

        <div class="more">
            <a href="#" class="more-a no-border"><?php echo __('More'); ?></a>
            <ul class="more-ul"></ul>
        </div>
    ...
    <div class="logo-box">
        <div class="site-logo">
            <a href="<?php echo get_url('homepage'); ?>">
    ...
    <div class="header-icons">
        ...
        <div class="header-icons-body">
            <div class="text email no-border">
                <a href="mailto:info@zarzuuch.com">info@zarzuuch.com</a>
            </div>
            ...
            <div class="active search">
                <form method="get" class="searchform">
                    <div>
                        <input type="text" value="" name="s" class="s" placeholder="<?php echo __('Search here'); ?>" />
                        <input type="submit" class="searchsubmit btn" value="<?php echo __('Go'); ?>" />
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="login-register">
        <div class="standart">
            <div class="links">
                <a href="<?php echo get_url('user_login'); ?>"><?php echo __('Login'); ?></a>
                <span>/</span>
                <a href="<?php echo get_url('user_register'); ?>"><?php echo __('Register'); ?></a>
            </div>
            <a class="btn" href="#"><?php echo __('Add Your Property'); ?></a>
        </div>
    </div>
    <!-- .login-register -->
