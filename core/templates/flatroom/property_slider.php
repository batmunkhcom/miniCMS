                    ...
                    <div class="entry-content">
                        <div class="shortcode properties-shortcode carousel-box first">
                            <h3 class="shortcode-title">
                                <a href="<?php echo get_url('real_estate_list', array('category_id' => 0)); ?>"><?php echo $slider_title; ?></a>
                            </h3>
                                            ...
                                            <div class="property no-dark">
                                                <div class="images-box">
                                                    ...
                                                    <div class="property-images-container">
                                                        <div class="images">
                                                            <?php
                                                            $object_photos = \Photo::getPhotosByCode($object->module_name . '_' . $object->id, array(
                                                                        'limit' => 3
                                                            ));
